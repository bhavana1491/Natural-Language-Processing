...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_letters(self):
        ...
        try: self.assertEqual("".join(self.f1.transduce(x for x in "wabbbaaw")), "w1")
        except: s.append(5)
    ...
    def test_morphology(self):
        ...
        try: self.assertEqual(generate("spruce+d"), "spruced")
        except: s.append(10)
        try: self.assertEqual(generate("ace+d"), "aced")
        except: s.append(11)
